...
(function() {
  ...
  cite_collection_contains_urn = function(urn) {
    var matching_rows;
    if (cite_collection.rows != null) {
      matching_rows = cite_collection.rows.filter(function(row) {
        return row[1] === urn;
  ...
  build_cts_ui = function() {
    var progress, translated_urns, urn, urn_li, _i, _len;
    ...
    return $('#translation_progress').attr('style', "width: " + progress + "%;");
  };
