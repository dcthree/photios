...
(function() {
  var FUSION_TABLES_URI, build_cts_cite_driver, check_table_access, default_cts_cite_collection_driver_config, delete_cookie, expires_in_to_date, filter_url_params, fusion_tables_escape, fusion_tables_query, get_cookie, get_valid_reff, get_valid_reff_xml_to_urn_list, google_oauth_parameters_for_fusion_tables, google_oauth_url, parse_query_string, set_access_token_cookie, set_author_name, set_cookie, set_cookie_expiration_callback;
  ...
  $(document).ready(function() {
    var cts_cite_collection_driver_config;
    console.log('ready');
